...
public interface IJobScheduler
{
   ...
   /// <summary>
   ///    Schedule a job to be performed as soon as possible, running under the given culture.
   /// </summary>
   /// <typeparam name="TJob">The type of job to execute.</typeparam>
   /// <typeparam name="TParameters">The type of parameters for the job.</typeparam>
   /// <param name="parameters">The parameters to pass to the job.</param>
   /// <param name="culture">The culture to run the job under. Applied to both the formatting and UI culture.</param>
   /// <param name="ct">A token to observe for cancellation requests.</param>
   /// <returns>A task representing the asynchronous operation.</returns>
   ...
   /// <typeparam name="TParameters">The type of parameters for the job.</typeparam>
   /// <param name="parameters">The collection of parameters, one for each job instance to schedule.</param>
   /// <param name="culture">The culture to run the jobs under. Applied to both the formatting and UI culture.</param>
   /// <param name="ct">A token to observe for cancellation requests.</param>
   /// <returns>A task representing the asynchronous operation.</returns>
   public Task PerformAsapAsync<TJob, TParameters>(IEnumerable<TParameters> parameters, CultureInfo culture, CancellationToken ct = default)
      where TJob : Job<TParameters>
      where TParameters : class;

   /// <summary>
   ///    Schedule a job to be performed as soon as possible with custom options, running under the given culture.
   /// </summary>
   /// <typeparam name="TJob">The type of job to execute.</typeparam>
   /// <typeparam name="TParameters">The type of parameters for the job.</typeparam>
   /// <param name="parameters">The parameters to pass to the job.</param>
   ...
   /// <summary>
   ///    Schedule a job to be performed at a given time, running under the given culture.
   /// </summary>
   /// <typeparam name="TJob">The type of job to execute.</typeparam>
   /// <typeparam name="TParameters">The type of parameters for the job.</typeparam>
   /// <param name="performAtUtc">The UTC time at which to perform the job.</param>
   ...
   /// <param name="ct">A token to observe for cancellation requests.</param>
   /// <returns>A task representing the asynchronous operation.</returns>
   public Task PerformAtAsync<TJob, TParameters>(DateTime performAtUtc, IEnumerable<TParameters> parameters, CultureInfo culture, CancellationToken ct = default)
      where TJob : Job<TParameters>
      where TParameters : class;

   /// <summary>
   ///    Schedule a job to be performed at a given time with custom options, running under the given culture.
   /// </summary>
   /// <typeparam name="TJob">The type of job to execute.</typeparam>
   /// <typeparam name="TParameters">The type of parameters for the job.</typeparam>
   /// <param name="performAtUtc">The UTC time at which to perform the job.</param>
   ...
   /// <summary>
   ///    Schedule a job to be performed repeatedly on a given CRON schedule, running under the given culture on every occurrence.
   /// </summary>
   /// <typeparam name="TJob">The type of job to execute.</typeparam>
   /// <typeparam name="TParameters">The type of parameters for the job.</typeparam>
   /// <param name="cronExpression">The CRON expression defining the schedule.</param>
   /// <param name="parameters">The parameters to pass to the job.</param>
   /// <param name="culture">The culture to run the job under. Applied to both the formatting and UI culture, and carried forward to every recurrence.</param>
   /// <param name="runImmediately">If true, the job will run immediately in addition to the scheduled times.</param>
   /// <param name="ct">A token to observe for cancellation requests.</param>
   /// <returns>A task representing the asynchronous operation.</returns>
